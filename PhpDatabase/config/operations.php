    ...
    class operations extends dbconfig
    {
        ...
        public function Store_Record()
        {
            ...
            if(isset($_POST['btn_save']))
            {
                ...
                $UserPhone = $db->check($_POST['UserPhone']);
                $UserEmail = $db->check($_POST['UserEmail']);

                if($this->insert_record($FirstName,$LastName,$UserPhone,$UserEmail))
                {
        ...
        {
            global $db;
            $query = "insert into user_info (FirstName,LastName, UserPhone,Email) values('$a','$b','$c','$d')";
        ...
        public function update()
        {
            ...
            if(isset($_POST['btn_update']))
            {
                ...
                if($this->update_record($ID,$FirstName,$LastName,$UserPhone,$Email ))
                {
        ...
        {
            global $db;
            $sql = "update user_info set FirstName='$first', LastName='$Last', UserPhone='$User', Email='$Email' where ID='$id'";
