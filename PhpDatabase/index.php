                    ...
                    <div class="card-header">
                        ...
                        <div class="card-body">
                            <form method="POST">
                                ...
                                <input type="text" name="UserPhone" placeholder=" Phone Number" class="form-control mb-2" required>
                                <input type="Email" name="UserEmail" placeholder=" Email" class="form-control mb-2" required>
                        </div>
                    <div class="card-footer">
                            <button class="btn btn-success" name="btn_save"> AddUser</button>
                            <a href="view.php" class="btn btn-primary"> SeeData </a>
                        </form>
                    </div>
                </div>
            </div>
